...
@section('content')
    ...
    <div class="body">
        <div class="prescription-body">
            ...
            <span class="prescription-date">Date: {{ date('j - m - Y', strtotime($patient_info->date)) }}</span>
            ...
            <form action="{{ route('update.prescription', $prescription->id) }}" method="POST">
                @csrf
                @php
                    $i = 0
                @endphp
                    ...
                    <table class="w-100 mt-4 prescription-table" id="table">
                        ...
                        <tr>
                            ...
                            <td class="prescription-td center">
                                <input value="{{ $medicine->name }}" type="text" name="medicines[{{ $i }}][name]" class="form-control" placeholder="Add medicine name">
                        ...
                        <tr>
                            ...
                            <td class="prescription-td center">
                                <input value="{{ $medicine->dosage }}" type="text" name="medicines[{{ $i }}][dosage]" class="form-control" placeholder="Enter the dosage">
                        ...
                        <tr>
                            ...
                            <td class="prescription-td center">
                                <input value="{{ $medicine->period }}" type="text" name="medicines[{{ $i }}][period]" class="form-control" placeholder="Enter the period">
                        ...
                        <tr>
                            ...
                            <td class="prescription-td center">
                                <input value="{{ $medicine->time }}" type="text" name="medicines[{{ $i }}][time]" class="form-control" placeholder="Enter the time">
                        ...
                        <tr>
                            ...
                            <td class="prescription-td">
                                <input value="{{ $medicine->notes }}" type="text" name="medicines[{{ $i }}][notes]" class="form-control" placeholder="Add Extra notes">
                            </td>
                        </tr>
            ...
            <footer class="footer">
                ...
                <span class="footer-span mt-2">Email: {{ $doctor_info->email }}</span>
